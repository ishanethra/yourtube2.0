...
const Header = ({ onToggleSidebar }: { onToggleSidebar: () => void }) => {
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 bg-white border-b dark:bg-black dark:border-gray-800">
          ...
          <>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuItem asChild>
                  <Link href="/premium">Premium download</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>

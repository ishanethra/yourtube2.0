    ...
    <header className="sticky top-0 z-50 flex items-center justify-between px-2 sm:px-4 bg-white/80 backdrop-blur-md border-b dark:bg-black/80 dark:border-gray-800" style={{ height: "var(--header-height)" }}>
      <div className="flex items-center gap-1 sm:gap-4">
        ...
        <Link href="/" className="flex items-center gap-1 shrink-0">
          ...
          <span className="text-lg sm:text-xl font-bold tracking-tight">YourTube</span>
        </Link>
      </div>
      ...
      <div className="flex items-center gap-1 sm:gap-2">
        ...
        {user ? (
          ...
          <Button
            ...
            onClick={() => {
              console.log("Sign-in button clicked. handlegooglesignin function status:", !!handlegooglesignin);
              handlegooglesignin?.();
            }}
          >
            {isAuthLoading ? (
